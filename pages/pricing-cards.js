...
function PricingCards() {
  return (
    ...
    <div className="flex items-center justify-center min-h-screen bg-slate-800">
        {/* inner container */}
        <div className="flex flex-col md:flex-row my-6 space-y-6 md:space-y-0 md:space-x-6 md:flex-row md:my-0">
            {/* col 1 */}
            <div className="bg-slate-700 rounded-xl text-white">
                ...
                <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
                    ...
                    <div className="flex justify-center">
                        <Link className="inline-block px-10 py-3 my-6 text-center border border-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 duration-200" href='#'>Purchase</Link>
                    </div>
                </div>
                {/* border */}
            ...
            <div className="bg-violet-600 rounded-xl text-white">
                ...
                <div className="p-8 mx-3 mt-3 rounded-t-xl bg-slate-800">
                    ...
                    <div className="flex justify-center">
                        <Link className="inline-block px-10 py-3 my-6 text-center border bg-violet-600 border-violet-600 rounded-lg hover:bg-violet-800 hover:border-violet-800 duration-200" href='#'>Purchase</Link>
                    </div>
                </div>
                {/* border */}
                <div className="border-t border-slate-700"></div>
