...
import HeadPhone from '../public/product-modal/headphone.png'
import Weight from '../public/product-modal/weight.png';
import Heart from '../public/product-modal/heart.png'
    ...
    return (
        ...
        <div className="flex items-center min-h-screen justify-center bg-slate-100">
            ...
            <div className="flex flex-col p-6 m-3 space-y-10 bg-white rounded-2xl shadow-2xl md:flex-row md:space-y-0 md:space-x-10 md:m-0 md:p-16">
                <div>
                    <Image src={HeadPhone} alt='' className="mx-auto hover:scale-105 duration-200 w-60" />
                </div>
                {/* content */}
                <div className="flex flex-col space-y-6">
                    ...
                    <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
                        ...
                        <div className="max-w-sm text-2xl font-medium">
                            Razor Kraken Kitty Edt Gaming Headset Quartz
                        </div>
                        {/* price */}
                        <div className="flex flex-col mb-4 space-y-3 text-center md:text-left">
                        ...
                        <div className="group">
                            <button className="w-full bg-blue-700 text-white border-b-8 border-b-blue-700 rounded-lg group-hover:border-t-8 group-hover:border-b-0 group-hover:bg-blue-700 group-hover:border-t-blue-700 group-hover:shadow-lg transition-all duration-150">
                                <div className="px-8 py-4 bg-blue-500 rounded-lg group-hover:bg-blue-700 duration-150">Add to cart</div>
                            </button>
                        </div>
                        {/* stock */}
                        ...
                        <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-4 md:flex-row">
                            <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-150">
                                <Image src={Weight} alt="" className="w-8"/>
                                <span>Add to cart</span>
                            </button>

                            <button className="flex items-center justify-center py-3 px-5 space-x-3 border-2 border-gray-300 rounded-lg shadow-sm hover:bg-opacity-30 hover:shadow-xl hover:-translate-y-0.5 transition-all duration-150">
                                <Image src={Heart} alt="" className="w-8"/>
