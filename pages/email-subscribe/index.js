...
import EmailImage from '../../public/email-subscribe/EmailImage.jpeg'
        ...
        <div className="flex items-center justify-center h-screen bg-zinc-700">
            <div className="bg-zinc-800 p-2 mx-6 rounded-2xl">
                <div className="flex flex-col md:flex-row rounded-l-xl">
                    <div>
                        <Image className="md:rounded-l-xl rounded-xl md:rounded-r-none w-full" src={EmailImage} alt='Email Image' width={180} height={200} object-fit />
                    </div>
                    <div className="p-6 md:p-12">
                        ...
                        <div className="flex flex-col mt-5 space-y-4 md:space-x-3 md:flex-row md:space-y-0">
                            <input type="text" placeholder="Enter your email address" className="p-2 px-4 text-center text-white bg-zinc-800 border border-zinc-600 w-full placeholder:text-sm placeholder:text-center md:text-left placeholder:md:text-left focus:outline-none" />
